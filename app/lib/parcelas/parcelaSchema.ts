...
export const parcelaSchema = z.object({
  ...
  n_sectores: z.number({
    invalid_type_error: 'El número de sectores debe ser un número entero.',
    required_error: 'El número de sectores es obligatorio.',
  })
    .int('El número de sectores debe ser un número entero.')
    .min(0, 'El número de sectores no puede ser negativo.')
    .max(5, 'El número de sectores no puede ser mayor a 5.'),
